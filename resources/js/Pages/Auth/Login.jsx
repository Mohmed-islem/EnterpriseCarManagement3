            ...
            <div className="page-header min-vh-100">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="position-relative bg-gradient-success h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style={{backgroundImage: 'url("https://img.ecmweb.com/files/base/ebm/ecmweb/image/2022/04/Photo_217716905____Scharfsinn86_Dreamstime.6266c039429ee.png?auto=format,compress&fit=fill&fill=blur&w=1200&h=630https://mygpstracker.nl/wp-content/uploads/brizy/imgs/shutterstock_1962565906-Klein-985x480x185x0x615x480x1661264258.jpg")', backgroundSize: 'cover'}}>
